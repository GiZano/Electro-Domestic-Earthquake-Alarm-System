...
window.I18N_DATA = {
        en: {
            ...
            road_120_label: 'v1.2.0 · Released', road_120: '<strong>On-Premise AI Reports</strong> — Ollama generates emergency reports on-premise, pushed over WebSocket.',
            road_12_label: 'v1.2.1 · Current', road_12: '<strong>Geo-Zoning &amp; Cooldown Fragmentation (GNSS-ready)</strong> — geohash Redis fast-path zone resolution, per-area cooldown locks, PostGIS <code>ST_Contains</code> as source of truth.',
            road_122_label: 'v1.2.2 · Serial fallback', road_122: '<strong>Zero-Trust Serial Fallback</strong> — ECDSA-signed telemetry over USB CDC when MQTT/WiFi is unreachable.',
            road_13_label: 'v1.3 · Synchronized GNSS', road_13: 'Optional GNSS module (NEO-6M/M8N), NTP + PPS timestamps, real coordinates replacing the hardcoded fix, ADXL345 calibration.',
            ...
            roadmap_details: 'See the detailed roadmap',
            roadmap_dev: 'Development', roadmap_res: 'Research',
            r1_label: 'R1 · Done', r1: '<strong>SIL STA/LTA cross-validation</strong> — pure C++ core, host orchestrator, metrics and trigger calibration on the synthetic fallback. Real ESM ground-truth validation remains.',
            r2_label: 'R2 · Next', r2: '<strong>AI benchmarking</strong> — P50/P99 latency of the local Ollama worker, hallucination rate, privacy/latency vs cloud baseline.',
            r3_label: 'R3 · Planned', r3: '<strong>Dissemination</strong> — open validation dataset (Zenodo DOI) + technical paper / preprint.',
            roadmap_res_note: 'R1 is the blocking prerequisite for the v2.2.0 Edge AI tier and runs in parallel with v1.3 (GNSS).',
        ...
        it: {
            ...
            road_120_label: 'v1.2.0 · Rilasciata', road_120: '<strong>Report AI On-Premise</strong> — Ollama genera i report di emergenza on-premise, inviati via WebSocket.',
            road_12_label: 'v1.2.1 · Attuale', road_12: '<strong>Geo-Zoning e frammentazione del cooldown (GNSS-ready)</strong> — risoluzione zona via indice geohash Redis fast-path, lock di cooldown per area, PostGIS <code>ST_Contains</code> come fonte di verità.',
            road_122_label: 'v1.2.2 · Fallback seriale', road_122: '<strong>Zero-Trust Serial Fallback</strong> — telemetria firmata ECDSA su USB CDC quando MQTT/WiFi non è raggiungibile.',
            road_13_label: 'v1.3 · GNSS sincronizzato', road_13: 'Modulo GNSS opzionale (NEO-6M/M8N), timestamp NTP + PPS, coordinate reali al posto del fix hardcoded, calibrazione ADXL345.',
            ...
            roadmap_details: 'Vedi la roadmap dettagliata',
            roadmap_dev: 'Sviluppo', roadmap_res: 'Ricerca',
            r1_label: 'R1 · Completata', r1: '<strong>Cross-validazione SIL STA/LTA</strong> — core C++ puro, orchestrator host, metriche e calibrazione dei trigger sul fallback sintetico. Resta la validazione su dati reali ESM.',
            r2_label: 'R2 · Prossima', r2: '<strong>Benchmark AI</strong> — latenza P50/P99 del worker Ollama locale, tasso di allucinazione, privacy/latenza rispetto al cloud.',
            r3_label: 'R3 · Pianificata', r3: '<strong>Disseminazione</strong> — dataset di validazione aperto (DOI Zenodo) + paper tecnico / preprint.',
            roadmap_res_note: 'R1 è il prerequisito bloccante del tier Edge AI v2.2.0 e corre in parallelo con v1.3 (GNSS).',
