...
| **#Research** | Ongoing — Scientific validation via **SIL cross-validation** (ground-truth INGV replay of the exact production C++ STA/LTA core, Python-only as orchestrator, ROC metrics) + AI benchmarking (latency P50/P99, hallucination rate). See [ROADMAP.md](ROADMAP.md) |
